...
- コンビニ、スーパー、専門店、食品スーパー、ホームセンター、部分失敗の18件を共有匿名コーパスへまとめ、総額、品目、Confidence判定を同じfixtureから評価する品質ゲートを追加した。
...
- 品目完全一致率、品目適合率・再現率、不要な要確認件数、誤High件数を計測し、誤High件数0をリリース条件とする。
