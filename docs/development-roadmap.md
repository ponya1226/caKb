...
- `receipt-confidence-v4` では、取得済み品目の合計が総額、または課税対象額を除いた印字税額を加えた総額と完全一致しない場合を要確認にする。
...
- コンビニ、スーパー、専門店、食品スーパー、部分失敗の11件を共有匿名コーパスへまとめ、総額、品目、Confidence判定を同じfixtureから評価する品質ゲートを追加した。
