...
1. Firebase Hosting URLでPC/スマホのGoogleログインを確認する
2. Google Vision ProxyにFirebase ID token検証を追加する
3. Firestore cloud repositoryを追加する
4. IndexedDBからFirestoreへの手動移行後にクラウド正本へ切り替えるUIを追加する
5. 家族招待コードとmember権限UIを追加する
